...
| Aral Arbatlı |    <ul><li>In charge of Q1 - Budget subsection analysis</li><li>Data Visualisation</li><li>Budget Dataset Preprocessing</li><li>Writing the Readme and the Data Story Text</li><li>Matching and Analysis</li></ul>  |  
